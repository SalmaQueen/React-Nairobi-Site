...
function AllMeetupsPage(){
  ...
  useEffect(() => { 
    setIsLoading(true);
    fetch('https://react-getting-started-4a0bb-default-rtdb.firebaseio.com/meetups.json').then(response => {
      ...
      <>
       <section style={{
        ...
        marginBottom:"15rem"
            ...
            <h1 style={{textAlign:"center",color:"white",fontFamily:"  Poppins, sans-serif", fontWeight:"bold", fontSize:"2.5rem", paddingTop:"1rem"}}>Meetups</h1>
